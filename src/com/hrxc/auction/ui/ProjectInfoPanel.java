...
public class ProjectInfoPanel extends javax.swing.JPanel {
    ...
    private static final Logger log = Logger.getLogger(ProjectInfoPanel.class);
    ...
    private void initComponents() {
        ...
        MyTableModel model = MyTableConfig.getProjectInfoTableModel();
        ...
        UITools.setTableProps(dataTable, MyTableConfig.ProjectInfo.columns);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(fd_projectNo, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void addBtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtonActionPerformed
        ProjectInfoEditDialog dialog = new ProjectInfoEditDialog((javax.swing.JFrame) this.getRootPane().getParent(), true, null, this);
    ...
    private void searchBtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtonActionPerformed
        String goodsNo = fd_projectNo.getText().trim();
        String goodsName = fd_projectName.getText().trim();
    ...
    private void editBtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtonActionPerformed
        if (UITools.getCheckedRows(dataTable) != 1) {
            ...
            ProjectInfo dto = ProjectInfoAction.getObjectById(pkId);
            ProjectInfoEditDialog dialog = new ProjectInfoEditDialog((javax.swing.JFrame) this.getRootPane().getParent(), true, dto, this);
            dialog.setLocationRelativeTo(this);
            dialog.setVisible(true);
        }
    ...
    private void deleteBtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtonActionPerformed
        if (UITools.getCheckedRows(dataTable) == 0) {
            ...
            if (JOptionPane.showConfirmDialog(this.getRootPane(), "请确认您是否要删除数据？") == JOptionPane.YES_OPTION) {
                ArrayList<String> list = UITools.getCheckedRowsId(dataTable);
                ProjectInfoAction.deleteObjectById(list);
